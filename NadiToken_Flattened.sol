...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC20/extensions/ERC20Burnable.sol
...
/**
 * @title Nadi Intelligence Network (NADI)
 * @dev Enterprise-grade utility token for PT. Satuutas Delta Teknologi.
 */
contract Nadi is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    
    uint256 public constant TOTAL_SUPPLY = 8_000_000_000 * 10 ** 18; // 8 Billion Tokens

    /**
     * @dev Constructor mints the entire fixed supply to the deployer's address.
     */
    constructor(address initialOwner) 
        ERC20("Nadi Intelligence Network", "NADI") 
        ERC20Permit("Nadi Intelligence Network") 
    ...
    /**
     * @dev Emergency recovery function. In case standard ERC20 tokens are accidentally 
     * sent to this contract address (a very common user error), the owner can recover them.
     */
    function recoverLostTokens(address _token, address _to, uint256 _amount) external onlyOwner {
        require(_token != address(this), "NADI: Cannot recover native tokens");
